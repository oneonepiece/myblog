...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/admin/recycle/list'}).trigger("reloadGrid");
}
...
// function addBlog() {
//     window.location.href = "/admin/recycle/edit";
// }

function recoveryBlog() {
    // window.location.href = "/admin/recycle/recovery";
...
function editBlog() {
    ...
    window.location.href = "/admin/recycle/edit/" + id;
}
