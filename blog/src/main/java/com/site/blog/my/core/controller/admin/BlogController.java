...
//            blogs.setBlogSubUrl(blogSubUrl);
//            blogs.setBlogCategoryId(blogCategoryId);
//            blogs.setBlogTags(blogTags);
//            blogs.setBlogContent(blogContent);
//            blogs.setBlogCoverImage(blogCoverImage);
//            blogs.setBlogStatus(blogStatus);
//            blogs.setEnableComment(enableComment);
