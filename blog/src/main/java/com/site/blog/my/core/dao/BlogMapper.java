...
public interface BlogMapper {
    ...
    //gan
    List<Blog> findBlogListByDeleted(PageQueryUtil pageUtil);
    int getTotalBlogsByDeleted(PageQueryUtil pageUtil);
    int recoveryBatch(Integer[] ids);
    int deleteBlogById(Integer[] ids);
 //   int deleteBlogByRelation(Integer[] ids);
